...
# ----------------------------------------------------------
# MAJ d'un script de David BOMBAL (cf. youtube)
# Francisation et adaptation locale
# Attention à bien passer la console Win en UTF-8
# Sinon avec l'encodage "DOS Latin" de base ca ne marche pas
# ----------------------------------------------------------
